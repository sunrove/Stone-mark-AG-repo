    ...
    >
      ...
      <div className="container relative z-10" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            >
              ...
              <p className="font-['DM_Sans'] text-white/60 text-lg leading-relaxed mb-8">
                We service any home within an hour of Murfreesboro, including the greater Middle Tennessee region across
          ...
          >
            <div className="bg-[#2A303C] border border-white/10 p-8">
              <div
