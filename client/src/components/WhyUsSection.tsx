...
export default function WhyUsSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }}
    >
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-[#2A303C]/90 border border-[#F97316]/30 p-5 backdrop-blur-sm">
                ...
                <div className="font-['DM_Sans'] text-white/70 text-sm">
                  In business with over 45 years of experience — serving Middle Tennessee with integrity
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-5">
            {differentiators.map((item, i) => {
              ...
              return (
                <div
                  key={item.title}
                  className={`p-5 border border-white/10 bg-[#2A303C]/60 hover:border-[#F97316]/40 transition-all duration-300 group ${
                    visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
                  }`}
