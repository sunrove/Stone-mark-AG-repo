...
const services = [
  ...
  },
  {
    ...
    description:
      "Durable, low-maintenance metal roofing systems. We offer popular and affordable Tuff Rib panels, as well as premium Standing Seam options for superior wind resistance. Superior wind and impact resistance with a modern aesthetic.",
    image:
  ...
  return (
    ...
    >
      ...
      {service.image ? (
        ...
        <div className="relative h-20 bg-[#323846] flex items-center justify-center">
...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-24 bg-[#2A303C]">
      <div className="container">
        ...
        <div className="mt-12 border border-[#F97316]/30 bg-[#F97316]/5 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <a
            href="https://wisetack.com/" target="_blank" rel="noopener noreferrer"
            className="btn-orange whitespace-nowrap flex-shrink-0"
          >Apply with Wisetack Financing
          </a>
        </div>
      </div>
    </section>
