    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-[#2A303C]/95 backdrop-blur-sm shadow-[0_2px_24px_rgba(0,0,0,0.6)] border-b border-[#F97316]/20"
            : "bg-[#2A303C]/80 backdrop-blur-sm border-b border-white/5"
        }`}
      >
      ...
      >
        ...
        <div
          className={`absolute top-0 right-0 h-full w-72 bg-[#2A303C] border-l border-[#F97316]/30 transition-transform duration-300 ${
