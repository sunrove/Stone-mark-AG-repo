...
function ReviewCard({ review, index, visible }: {
  ...
  return (
    <div
      className={`bg-[#323846] border border-white/10 p-6 hover:border-[#F97316]/40 transition-all duration-500 group relative ${
...
export default function ReviewsSection() {
  ...
  return (
    <section id="reviews" className="py-24 bg-[#2A303C]">
      <div className="container" ref={ref}>
        ...
        >
          ...
          {/* Google rating badge */}
          <div className="flex items-center gap-4 bg-[#323846] border border-white/10 px-6 py-4 self-start md:self-auto">
            <div>
              <div
