...
export default function ContactSection() {
  ...
  const inputClass =
    "w-full bg-[#323846] border border-white/15 text-white placeholder-white/30 px-4 py-3 font-['DM_Sans'] text-sm focus:outline-none focus:border-[#F97316]/60 transition-colors";

  return (
    <section id="contact" className="py-24 bg-[#2A303C]">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Contact cards */}
            <div className="border border-white/10 bg-[#323846] p-6">
              <div
