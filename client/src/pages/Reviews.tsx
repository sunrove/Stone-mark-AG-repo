...
const HERO_IMAGE = "/images/shingles_underlayment.png";
...
export default function Reviews() {
  return (
    <PageLayout>
      ...
      {/* Rating summary */}
      <section className="py-16 bg-[#2A303C]">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="md:col-span-1 bg-[#323846] border border-[#F97316]/30 p-8 flex flex-col items-center justify-center text-center">
              ...
              <div className="font-['DM_Sans'] text-white/50 text-sm">Based on 25 reviews</div>
            </div>
            <div className="md:col-span-2 bg-[#323846] border border-white/10 p-8">
              ...
              {[5, 4, 3, 2, 1].map((stars) => (
                <div key={stars} className="flex items-center gap-4 mb-3">
                  ...
                  <div className="flex-1 h-2 bg-[#2A303C] relative">
                    <div
              ...
              <p className="font-['DM_Sans'] text-white/40 text-xs mt-4">All 25 reviews are 5-star ratings on Google.</p>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {themes.map((t) => {
                const Icon = t.icon;
                return (
                  <div key={t.title} className="p-5 border border-white/10 bg-[#323846]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {reviews.map((r, i) => (
              <div key={i} className="bg-[#323846] border border-white/10 p-6 hover:border-[#F97316]/40 transition-all duration-300 relative group">
