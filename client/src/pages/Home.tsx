...
const HERO_IMAGE =
  "/images/hero_roof.png";
const SHINGLE_IMAGE =
  "/images/shingles_underlayment.png";
const METAL_IMAGE =
...
function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: "#2A303C" }}>
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${HERO_IMAGE})` }} />
      <div className="absolute inset-0 bg-gradient-to-r from-[#2A303C]/96 via-[#2A303C]/82 to-[#2A303C]/35" />
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-[#2A303C]" style={{ clipPath: "polygon(0 60%, 100% 0%, 100% 100%, 0% 100%)" }} />
...
function StatsBar() {
  ...
  return (
    <section id="stats" ref={ref} className="relative bg-[#2A303C] border-y border-[#F97316]/30" style={{ background: "linear-gradient(135deg, #2A303C 0%, #323846 100%)" }}>
...
function ServicesOverview() {
  ...
  return (
    <section className="py-24 bg-[#2A303C]" ref={ref}>
      <div className="container">
          ...
          {serviceCards.map((s, i) => (
            ...
            >
              <div className="relative h-44 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#2A303C] to-transparent" />
...
function WhyUsPreview() {
  const { ref, visible } = useVisible(0.1);
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }} ref={ref}>
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {highlights.map((item, i) => {
            ...
            return (
              <div key={item.title} className={`p-5 border border-white/10 bg-[#2A303C]/60 hover:border-[#F97316]/40 transition-all duration-300 group ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{ transitionDelay: `${i * 80}ms` }}>
    ...
    <section className="py-24 bg-[#2A303C]" ref={ref}>
      <div className="container">
        <div className={`mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <div className="flex items-center gap-4 bg-[#323846] border border-white/10 px-6 py-4 self-start">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          {featuredReviews.map((r, i) => (
            <div key={i} className={`bg-[#323846] border border-white/10 p-6 hover:border-[#F97316]/40 transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 80}ms` }}>
