...
const HERO_IMAGE   = "/images/hero_roof.png";
...
const credentials = [
  ...
  { label: "Over 45 Years Experience", desc: "Over a decade of serving Middle Tennessee homeowners and businesses, building a reputation on quality, reliability, and honest dealing." },
];
...
const timeline = [
  ...
  { year: "45+", title: "StoneMark Founded", desc: "Robert establishes The StoneMark Company, bringing his 45+ years of experience under a formal business structure focused on residential and light commercial roofing." },
...
export default function About() {
  return (
    <PageLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 font-['DM_Sans'] text-white/70 text-base leading-relaxed">
                ...
                <p>Robert founded The StoneMark Company with over 45 years of experience in the construction industry to bring the full weight of his experience to Nashville-area homeowners and businesses under a professional, warranty-backed operation. Since then, StoneMark has earned a 5.0 Google rating, an A+ BBB rating, and recognition from the Middle Tennessee Home Builders Association for craftsmanship.</p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-[#2A303C]/90 border border-[#F97316]/30 p-5 backdrop-blur-sm">
      ...
      {/* Company values */}
      <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }}>
        <div className="container">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-[3px] bg-[#F97316]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v) => {
              const Icon = v.icon;
              return (
                <div key={v.title} className="p-6 border border-white/10 bg-[#2A303C]/60 hover:border-[#F97316]/40 transition-all duration-300 group">
      ...
      {/* Credentials */}
      <section className="py-24" style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }}>
        <div className="container">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-[3px] bg-[#F97316]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {credentials.map((c) => (
              <div key={c.label} className="p-6 border border-white/10 bg-[#2A303C]/60 hover:border-[#F97316]/40 transition-all duration-300">
