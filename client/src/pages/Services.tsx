...
const SHINGLE_IMAGE = "/images/shingles_underlayment.png";
...
const services = [
  ...
  {
    id: "metal-roofing",
    title: "Metal Roofing (Tuff Rib & Standing Seam)",
    tag: "Premium",
    image: METAL_IMAGE,
...
const faqs = [
  ...
  { q: "What warranty do I get on a new roof?", a: "The GAF System Plus Warranty provides for a full 50 years of non prorated protection. It is transferrable to the next buyer. We also provide our own workmanship guarantee, and will explain all warranty options during your consultation." },
    ...
    <section className="py-24" style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }}>
      <div className="container">
        ...
        <div className="max-w-3xl space-y-2">
          {faqs.map((faq, i) => (
            <div key={i} className="border border-white/10 bg-[#2A303C]/60">
              <button
            ...
            <div key={service.id} id={service.id} className={`grid lg:grid-cols-2 gap-12 items-start ${i % 2 === 1 ? "lg:grid-flow-dense" : ""}`}>
              ...
              <div className={i % 2 === 1 ? "lg:col-start-2" : ""}>
                {service.image ? (
                  ...
                  <div className="relative h-64 bg-[#323846] border border-white/10 flex items-center justify-center">
