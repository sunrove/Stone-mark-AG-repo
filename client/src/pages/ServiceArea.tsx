  ...
  return (
    <PageLayout>
      <PageHero
        ...
        subtitle="We service any home within an hour of Murfreesboro, including homeowners and businesses across Davidson, Williamson, Rutherford, and Maury counties — and the communities in between."
        bgImage={HERO_IMAGE}
      />
      ...
      <section className="py-24 bg-[#2A303C]">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
            <div>
              ...
              <div className="space-y-4 font-['DM_Sans'] text-white/70 text-base leading-relaxed">
                <p>StoneMark serves the greater Middle Tennessee region. We service any home within an hour of Murfreesboro, covering primary counties — Davidson, Williamson, Rutherford, and Maury — encompassing dozens of cities and communities from the Nashville metro to the southern suburbs.</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={stat.label} className="bg-[#323846] border border-white/10 p-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {counties.map((county) => (
              <div key={county.name} className="border border-white/10 bg-[#323846] hover:border-[#F97316]/40 transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {county.cities.map((city) => (
                      <div key={city} className="flex items-center gap-1.5 bg-[#2A303C] border border-white/10 px-3 py-1.5">
          ...
          {/* Full city list */}
          <div className="bg-[#323846] border border-white/10 p-8">
      ...
      <section className="py-24" style={{ background: "linear-gradient(135deg, #323846 0%, #2A303C 100%)" }}>
        <div className="container">
          ...
          <div className="max-w-3xl space-y-5">
            {faqArea.map((faq, i) => (
              <div key={i} className="border border-white/10 bg-[#2A303C]/60 p-6">
